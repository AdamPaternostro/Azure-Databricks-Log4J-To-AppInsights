...
dbfs cp applicationinsights-core-2.3.0.jar              dbfs:/databricks/appinsights/applicationinsights-core-2.3.0.jar
dbfs cp applicationinsights-logging-log4j1_2-2.3.0.jar  dbfs:/databricks/appinsights/applicationinsights-logging-log4j1_2-2.3.0.jar

echo "Uploading cluster init script"
dbfs cp appinsights_logging_init.sh                     dbfs:/databricks/appinsights/appinsights_logging_init.sh
